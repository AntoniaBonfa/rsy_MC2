...
ggplot(df_csim_long, aes(value))+
  ...
  labs(title = "Dichteplot von Cosinus-Ähnlichkeit",
       x = "minimale Cosinus-Ähnlichkeit",
       y = "Dichte")
